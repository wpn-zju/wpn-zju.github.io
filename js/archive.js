...
(function () {
    ...
    $(document).ready(function () {
            ...
            for (i = 0; i < sectionArticles.length; i++) {
                ...
                for (j = 0; j < $articles.length; j++) {
                    ...
                    for (k = 0; k < tags.length; k++) {
                        // Assume that each post only have 1 category.
                        if (categories[0] === tag.split('.')[0]) {
                            if (typeof tag === undefined || (tag.split('.')[1] === 'Null' || tags[k] === tag.split('.')[1])) {
                                result[i] || (result[i] = {});
                                result[i][j] = true;
                            }
                        }
        ...
        tagSelect(window.location.pathname.split('/')[2].split('_')[1] + '.Null');
